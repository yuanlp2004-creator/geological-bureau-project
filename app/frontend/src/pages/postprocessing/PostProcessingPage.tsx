...
export function PostProcessingPage({ token, initialView, onViewChange, canWrite, canExecute, canExport, onToast }: Props) {
  ...
  return <div className="page-content postprocessing-page refined-page remaining-page" data-testid="postprocessing-page" data-navigation-view={view}>
