import { TaskLayout, FormDisclosure } from '../../layout/TaskLayout'
...
import { SimpleChartAxes } from '../../components/SimpleChartAxes'
...
export function MercuryCalibrationPage({ token, canWrite, canExecute, onToast }: Props) {
  ...
  const [name, setName] = useState('汞灯光学校准')
  ...
  const create = async (event: FormEvent) => {
    ...
    } catch (error) { setCreateError(error instanceof Error ? error.message : '创建汞灯校准会话失败'); onToast(error instanceof Error ? error.message : '创建汞灯校准会话失败') }
